...
//        
    func vibrate(style:VibrationStyle = .default) {
        UIImpactFeedbackGenerator(style: style == .default ? .light : .heavy).impactOccurred()
//        let intensity = CHHapticEventParameter(parameterID: .hapticIntensity, value: style == .default ? 0.3 : 0.5)
